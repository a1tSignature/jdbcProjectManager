...
public final class AndroidBackendDeveloper extends BasePosition implements BackendDeveloper {
    ...
    public void developServiceModule() {
        ...
        System.out.println("Developing Android di.com.a1tSign.projectManager.service module...");
        status[2] = true;
    }
    ...
    public void doReport() {
        ...
        if (status[2])
            System.out.println("Performed work on the development of a android di.com.a1tSign.projectManager.service module");
